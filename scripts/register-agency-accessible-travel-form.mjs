...
const wheelchairRequiredWhenVisibleSuffixes = [
  '_wheelchair_usage',
  '_vehicle_boarding_preference',
  '_wheelchair_manufacturer',
  '_wheelchair_model',
  '_wheelchair_length_cm',
  '_wheelchair_width_cm',
  '_wheelchair_depth_cm',
  '_wheelchair_height_cm',
  '_wheelchair_weight_kg',
  '_wheelchair_foldable',
];

function isRequiredWhenVisible(fieldName) {
  return wheelchairRequiredWhenVisibleSuffixes.some((suffix) => fieldName.endsWith(suffix));
}
