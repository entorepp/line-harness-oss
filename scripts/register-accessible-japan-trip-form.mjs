...
const payload = {
  ...
  fields: [
    ...
    {
      name: 'hotel_grade',
      label: 'Preferred hotel grade',
      type: 'radio',
      required: true,
      helperText: 'We will use this preference to recommend hotels as part of a hotel + transportation package.',
      options: [
        '3-star (¥30,000–50,000/night)',
        '4-star (¥50,000–80,000/night)',
        '5-star (¥80,000+/night)',
        'Flexible / not sure',
      ],
    },
    ...
    },
    {
      ...
      required: true,
      options: [
        'Twin beds (2 separate beds)',
        'Double / queen bed (1 large bed)',
        'A mix of room types',
        'Flexible / not sure',
      ],
    },
    ...
    },
    {
      ...
      label: 'About how long would you like your trip to be?',
      type: 'text',
      required: true,
      helperText: 'A rough estimate is fine.',
      placeholder: 'e.g. About 10 days',
      visibleWhen: {
        field: 'dates_decided',
        operator: 'equals',
        value: 'No',
  ...
  successDescription: 'Flat Travel will review your route and contact you with a hotel + transportation package proposal.',
  onSubmitTagId: null,
